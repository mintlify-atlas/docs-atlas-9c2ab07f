...
2. **[Protocol](/concepts/communication-protocol)** - Learn the beacon protocol
3. **[Server API](/api/server/server-main)** - Explore server internals
4. **[Agent API](/api/agent/beacon)** - Explore agent internals
5. **[Operational Guide](/operator/session-management)** - Advanced session management
